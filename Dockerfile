...
# Build-time environment variables (solo lo necesario para el build de Next)
# Secretos de email/SMTP NO van aquí: se inyectan en runtime vía docker-compose environment
