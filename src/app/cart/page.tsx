        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-lg shadow-sm border overflow-hidden">
              ...
              {cartItems.some(item => item.variant && item.variant.stock <= 0) && (
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <h3 className="text-sm font-medium text-orange-800">
                        Productos bajo pedido en tu carrito
                      </h3>
                      <p className="text-sm text-orange-700 mt-1">
                        Algunos productos en tu carrito están marcados como "bajo pedido". Estos se fabricarán/enviarán una vez confirmado el pedido. Tiempo estimado de entrega: 7-15 días laborables.
                      </p>
                    </div>
                  </div>
                </div>
